...
public class Parser implements Demultiplexer {
  ...
  private native int avGetAudioBitsPerSample(long peer);
  ...
  public void setSource(DataSource source) throws IncompatibleSourceException {
    ...
    if(isAudioPresent)
    {
      ...
      audioBitsPerSample = avGetAudioBitsPerSample(peer);
    }
    ...
    if(isAudioPresent)
    {
      ...
      tracks[trackIndex++] = new AudioTrack(audioSampleRate, audioChannelNumber, audioBitsPerSample,
